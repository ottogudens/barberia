...
<section class="hero-section" id="home-section">
    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-10">
                <h1 class="hero-title text-white mb-4 animate-fade-in">Bienvenidos a <span
                        class="glow-text"><?php echo isset($settings['shop_name']) ? $settings['shop_name'] : 'Gold Luk Barbershop'; ?></span>
                </h1>
                <p class="hero-subtitle text-white-50 mb-5 animate-fade-in" style="animation-delay: 0.2s;">Estilo,
                    elegancia y atención personalizada para el hombre
                    moderno.</p>
                <a href="appointment.php" class="btn btn-gold-premium btn-lg animate-fade-in"
                    style="animation-delay: 0.4s;">Reservar Cita</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <?php foreach ($services as $service): ?>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-box glass-card text-center p-4 h-100 shadow-sm border-0">
...
<!-- ABOUT SECTION -->
<section class="about-section py-5 bg-light animate-fade-in" id="about">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <img src="Design/images/about-1.jpg" alt="About Us"
                    class="img-fluid rounded shadow highlight-img glass-card p-2">
            </div>
            <div class="col-lg-6 pl-lg-5">
                <h2 class="text-uppercase mb-4 glow-text">Sobre Nosotros</h2>
                ...
                <a href="#contact-us" class="btn btn-dark btn-gold-premium border-0">Contáctanos</a>
            </div>
        </div>
    </div>
</section>
...
<!-- TEAM SECTION -->
<section class="team-section py-5 animate-fade-in" id="team">
    <div class="container">
        <div class="section-title text-center mb-5">
        ...
        <div class="row justify-content-center">
            <?php foreach ($employees as $employee): ?>
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="team-member text-center glass-card p-4">
                        ...
                        <h5 class="mb-1 text-white"><?php echo $employee['first_name'] . ' ' . $employee['last_name']; ?>
                        </h5>
...
<?php if (count($gallery) > 0): ?>
    <section class="gallery-section py-5 bg-dark animate-fade-in" id="gallery">
        <div class="container">
            <div class="section-title text-center mb-5">
                <h2 class="text-uppercase text-white glow-text">Nuestra Galería</h2>
                <div class="divider mx-auto bg-gold"></div>
            </div>
            <div class="row">
                <?php foreach ($gallery as $img): ?>
                    <div class="col-md-3 col-6 mb-4">
                        <div class="gallery-item glass-card p-1">
                            <img src="<?php echo $img['image_path']; ?>" alt="Gallery" class="img-fluid rounded"
...
<!-- CONTACT SECTION -->
<section class="contact-section py-5 animate-fade-in" id="contact-us">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-4">
                <div class="glass-card p-5 h-100">
                    <h2 class="text-uppercase mb-4 glow-text">Visítanos</h2>
                    <div class="divider bg-gold mb-4" style="width: 40px; height: 3px;"></div>
                    <ul class="list-unstyled contact-info">
                        <li class="mb-3 text-white"><i class="fas fa-map-marker-alt text-gold mr-3"></i>
                            <?php echo isset($settings['contact_address']) ? htmlspecialchars($settings['contact_address']) : '123 Calle Principal'; ?>
                        </li>
                        <li class="mb-3 text-white"><i class="fas fa-phone text-gold mr-3"></i>
                            <?php echo isset($settings['contact_phone']) ? htmlspecialchars($settings['contact_phone']) : '+1 234 567 890'; ?>
                        </li>
                        <li class="mb-3 text-white"><i class="fas fa-envelope text-gold mr-3"></i>
                            <?php echo isset($settings['contact_email']) ? htmlspecialchars($settings['contact_email']) : 'contacto@goldluk.com'; ?>
                        </li>
                        <li class="mb-3 text-white"><i class="fas fa-clock text-gold mr-3"></i> Lun - Sáb: 9:00 AM -
                            8:00 PM</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="glass-card p-2 h-100 overflow-hidden">
                    <!-- Map -->
                    <?php
