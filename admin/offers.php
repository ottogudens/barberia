                        ...
                        <?php foreach ($offers as $offer): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="offers.php?do=Delete" style="display:inline-block;"
            ...
            if (isset($_POST['add_offer'])) {
                ...
                if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
                    ...
                    if ($uploadResult['success']) {
                        $image_path_db = $uploadResult['path'];
                    } else {
                        echo "<div class='alert alert-warning'>{$uploadResult['error']} La oferta se guardará sin imagen o con la actual.</div>";
                    }
                }
